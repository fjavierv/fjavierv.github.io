    ...
    */
    ...
    _find: function( params, callback ) {
        ...
        params = $.extend({
            ...
            extras: 'url_t,url_m,url_o,url_s,url_l,url_z,description,date_upload',
        ...
        return this._call( params, function(data) {
            ...
            // El siguiente método no tiene ordenación en flickr,
            // luego debemos hacerla nosotros mismos. Ordenaremos
            // según la fecha de subida.
            if(params.method === 'flickr.photosets.getPhotos') {
                data.photoset.photo = _.sortBy(data.photoset.photo, function(photo) {
                    return photo.dateupload * -1;
                });
            }
